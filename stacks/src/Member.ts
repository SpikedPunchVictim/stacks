import { IModel, Model, ModelCreateParams, SymbolEntry } from "./Model"
import { IStackContext } from "./stack/StackContext"
import { UidKeeper } from "./UidKeeper"
import { ObjectRefValue } from "./values/ObjectRef"
      ...
      for (let key of Object.keys(params)) {
         ...
         if (typeof value === 'function') {
            ...
            */
            ...
            let castModel = Model.asModel(value)

            if(castModel !== undefined) {
               let refValue = new ObjectRefValue(castModel.name, UidKeeper.IdNotSet, context)
